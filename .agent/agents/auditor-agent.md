...
## Skills Obrigatórias
```
view_file skills/adaptive-reasoning/SKILL.md     ← checklist de coerência e anti-loops
view_file skills/deploy-production/SKILL.md      ← padrões de prontidão para produção
```
