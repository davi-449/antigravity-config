...
- Se domínio = frontend: `view_file skills/ui-components/SKILL.md`
- Se domínio = backend: `view_file skills/backend-patterns/SKILL.md` e `skills/auth/SKILL.md`
- Se domínio = banco: `view_file skills/database/SKILL.md`
</mandatory_skills>
