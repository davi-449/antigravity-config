...
- `view_file skills/adaptive-reasoning/SKILL.md` (para raciocínio de hipótese e auto-healing)
- `view_file skills/database/SKILL.md` (se o bug envolver PostgreSQL/RLS)
</mandatory_skills>
