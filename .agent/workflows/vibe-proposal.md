...
```
view_file C:/Users/admin/.gemini/config/skills/adaptive-reasoning/SKILL.md       ← protocolo de raciocínio e anti-loops
view_file C:/Users/admin/.gemini/config/skills/obsidian/SKILL.md                  ← protocolo de leitura/escrita de memória
```
...
```
view_file C:/Users/admin/.gemini/config/skills/deciqai-bayesian-reasoning/SKILL.md   ← avaliação de risco e probabilidade
view_file C:/Users/admin/.gemini/config/skills/adaptive-reasoning/SKILL.md            ← checklist de coerência final
```
