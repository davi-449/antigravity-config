...
view_file skills/adaptive-reasoning/SKILL.md
view_file skills/obsidian/SKILL.md
<se frontend>  view_file skills/ui-components/SKILL.md
<se backend>   view_file skills/backend-patterns/SKILL.md
<se backend>   view_file skills/auth/SKILL.md
<se banco>     view_file skills/database/SKILL.md
