...
```
view_file C:/Users/admin/.gemini/config/skills/adaptive-reasoning/SKILL.md     ← protocolo de raciocínio, rollback e anti-loops
```
...
```
view_file C:/Users/admin/.gemini/config/skills/frontend-design-pro/SKILL.md    ← paleta, componentes, estados obrigatórios
view_file C:/Users/admin/.gemini/config/skills/frontend-design-3/SKILL.md      ← formulários, tabelas, upload, UX financeiro
view_file C:/Users/admin/.gemini/config/skills/afrexai-nextjs-production/SKILL.md  ← App Router, Server vs Client, env vars
```
...
```
view_file C:/Users/admin/.gemini/config/skills/supabase/SKILL.md    ← auth headless, schema dump, RLS, RPCs, checklist
view_file C:/Users/admin/.gemini/config/skills/backend/SKILL.md     ← Server Actions, Edge Functions, segurança, anti-patterns
```
...
```
view_file C:/Users/admin/.gemini/config/skills/adaptive-reasoning/SKILL.md    ← Step 4: Checklist de Coerência Final
```
...
```
view_file C:/Users/admin/.gemini/config/skills/adaptive-reasoning/SKILL.md    ← Step 3: Resultado Divergente = Nova Hipótese
```
