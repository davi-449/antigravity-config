...
Leia as skills base:
```
view_file skills/adaptive-reasoning/SKILL.md
view_file skills/obsidian/SKILL.md
```
...
- Leia: `view_file skills/database/SKILL.md`
...
- Leia: `view_file skills/backend-patterns/SKILL.md`
- Se envolver auth: `view_file skills/auth/SKILL.md`
...
- Leia: `view_file skills/ui-components/SKILL.md`
- Se envolver animações: `view_file skills/ui-motion/SKILL.md`
