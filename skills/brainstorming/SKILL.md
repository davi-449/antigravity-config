...
Persist the document according to the project's standard workflow (`specs/<id>/proposal.md`).
...
- Antes de `/vibe-proposal`
- Quando o usuário tiver uma ideia vaga que precisa ser clarificada
